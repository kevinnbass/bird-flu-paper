...
# IMPORTANT: Escape all braces in the JSON you want to appear literally by using double braces.
PROMPT_SPREAD_RISK = """
...
def main():
    ...
    with open(OUTPUT_FILE, 'a', encoding='utf-8') as outfile:
        for idx, article in enumerate(tqdm(valid_articles, desc="Processing 20 valid articles")):
            ...
            # Use ensure_ascii=False so non-ASCII characters remain unescaped
