...
def run_pipeline_for_df(
    ...
    # 6) The SENS run => merges small outlets (within each category) => 'OtherSmall'
...
def run_pipeline_for_df_no_collapse(
    ...
    """
    A variant of run_pipeline_for_df that does NOT merge small outlets into 'OtherSmall'.
    ...
    # This version has NO SENS step, so we skip merging small clusters.
    print(f"[NoCollapse] => Completed pipeline for prefix={prefix} with no merging.")
