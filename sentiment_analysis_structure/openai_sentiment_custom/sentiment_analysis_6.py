...
def plot_cluster_bar(data, group, category, value, title, ylabel, filename, palette=None, hue_order=None):
    """
    ...
    sns.barplot(
        ...
        hue=category,
        palette=palette,
        hue_order=hue_order  # Correct parameter for hue ordering
    )
...
def main():
    ...
    try:
        plot_cluster_bar(
            ...
            hue_order=sentiment_order  # Updated parameter
        )
    except Exception as e:
    ...
    try:
        plot_cluster_bar(
            ...
            hue_order=fear_order  # Updated parameter
        )
    except Exception as e:
