...
def fit_gee_and_pairwise(df, sentiment, measure_type='Quotation', cov_struct_type=Exchangeable):
    # ... (same as previous code block for fitting GEE and calculating QIC)
    # The function body remains unchanged from the previous version provided.
    # Just ensure it is included in this final code block for completeness.
