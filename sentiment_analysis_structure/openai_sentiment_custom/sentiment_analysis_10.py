...
def main():
    ...
    sentiment_category_with_gaps = add_dummy_gaps(sentiment_category, ordered_outlets, group_col='category', categorical_col='sentiment')
    fear_category_with_gaps = add_dummy_gaps(fear_category, ordered_outlets, group_col='category', categorical_col='fear')
