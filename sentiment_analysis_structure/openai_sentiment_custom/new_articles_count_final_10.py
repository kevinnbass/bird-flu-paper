...
# Update the y-axis label with increased font size
plt.ylabel('Number of Articles', fontsize=24)  # Increased by 50% from previous 16
...
# Keep y-axis tick labels the same
plt.yticks(fontsize=19)  # Remains unchanged
