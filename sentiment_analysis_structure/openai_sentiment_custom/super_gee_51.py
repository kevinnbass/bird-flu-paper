...
def pairwise_and_diagnostics(
    ...
    if final_fit is None:
        # If refitting fails, return None
    ...
    # -------------------------------------------------------------------
    # Example calls => adjust function names + B as needed
    ...
    if not boot_params_df.empty:
        param_mean_boot = boot_params_df.mean().round(4).to_dict()
        param_std_boot  = boot_params_df.std().round(4).to_dict()
    else:
        param_mean_boot = {}
        param_std_boot  = {}

    if not jk_params_df.empty:
        param_mean_jk = jk_params_df.mean().round(4).to_dict()
        param_std_jk  = jk_params_df.std().round(4).to_dict()
    else:
        param_mean_jk = {}
        param_std_jk  = {}

    # Combine them in "boot_info" dict
    boot_info = {
