...
def main():
    ...
    try:
        plot_cluster_bar(
            data=sentiment_outlet[sentiment_outlet['sentiment'] == 'negative'],
            group='source',
            category='sentiment',
            value='proportion',
    ...
    try:
        plot_cluster_bar(
            data=sentiment_category[sentiment_category['sentiment'] == 'negative'],
            group='category',
            category='sentiment',
            value='proportion',
    ...
    try:
        plot_cluster_bar(
            data=fear_outlet[fear_outlet['fear'] == 'fearmongering'],
            group='source',
            category='fear',
            value='proportion',
    ...
    try:
        plot_cluster_bar(
            data=fear_category[fear_category['fear'] == 'fearmongering'],
            group='category',
            category='fear',
            value='proportion',
