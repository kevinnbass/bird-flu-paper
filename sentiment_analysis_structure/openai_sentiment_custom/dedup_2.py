...
# ---------------------------------------------------------------------------
# 1) Convert readability_indices_curated.xlsx to readability_indices_curated.jsonl
# ---------------------------------------------------------------------------
...
if __name__ == "__main__":
    excel_file = "readability_indices_curated.xlsx"
    intermediate_jsonl = "readability_indices_curated.jsonl"
    output_jsonl = "readability_indices_curated_cleaned.jsonl"
