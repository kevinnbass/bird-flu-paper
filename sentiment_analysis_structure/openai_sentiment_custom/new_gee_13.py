...
OUTPUT_EXCEL_CORRELATION = 'analysis_correlation_data.xlsx'  # New file for correlation data
...
def main():
    ...
    # Normalize each sentiment's scores (z-score) so they are comparable
    ...
    # Create a single scatter plot for all sentiments using normalized values
    plt.figure(figsize=(10, 8))
    sns.scatterplot(x='Quotation_Z', y='Fulltext_Z', hue='Sentiment/Emotion', data=combined_all, s=50)
    plt.title("All Sentiments Combined (Normalized Quotation vs Fulltext)")
