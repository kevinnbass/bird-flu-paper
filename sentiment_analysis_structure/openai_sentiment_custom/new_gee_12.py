...
def main():
    ...
    correlation_results = []
    # We'll also prepare data for scatter plots and saving to Excel
    correlation_scatter_data = {}  # {sentiment: dataframe with category, Quotation_Average, Fulltext_Average}

    for sentiment in CATEGORIES:
        sentiment_data = aggregated_df[aggregated_df['Sentiment/Emotion'] == sentiment]
        # Only consider defined categories
        ...
        # Create a scatter plot for each sentiment
    ...
    # Save correlation data and scatter data to an Excel
