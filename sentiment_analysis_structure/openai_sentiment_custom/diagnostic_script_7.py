...
def remove_low_variance_outlets(df, score_col, threshold=1e-4):
...
def main():
    ...
    # Apply stricter criteria for outlet removal based on near-zero variance
    df = remove_low_variance_outlets(df, measure_col, threshold=1e-4)
