...
# --------------------------------------------------------------------------------
# 3) unify_rows_across_measures => gather data, then forcibly blank Fulltext/Title if Quotation=NaN
...
def unify_rows_across_measures(df, sentiment, measure_group):
    ...
    # forcibly blank if Quotation=NaN
    ...
    # forcibly blank if Quotation_Intensity=NaN
...
# --------------------------------------------------------------------------------
# 4) CREATE THE 50TAB => measure_alignment_groups => produce separate tabs
# --------------------------------------------------------------------------------
